...
def get_hp_config():
    ...
    'loss_class_gamma' : 1, # 2 works and 0 works. , # try with 1 here and 0.75 below # # gamma=0 no wieght. Between 0 and 1 seems very unstable... In general, this here above 0 seems unstable... At least the the reg values below 
