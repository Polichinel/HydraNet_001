...
def get_posterior(unet, views_vol, device, n):
    ...
    for i in range(mean_array.shape[0]): #  0 of mean array is the temporal dim
        ...
        out_sample_month_list.append(i)
        mse_list.append(mse)
...
def model_pipeline(hyperparameters):
    ...
    with wandb.init(project="RUNET_VIEWS_REP_pickeled", entity="nornir", config=hyperparameters): #monthly36 when you get there--
