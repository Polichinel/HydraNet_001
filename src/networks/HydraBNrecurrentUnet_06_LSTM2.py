...
class HydraBNUNet06_LSTM2(nn.Module):
    ...
    def forward(self, x, h):
        ...
        h = torch.cat([hs_1, hs_2, hl_1, hl_2], 1) # concatenating short and long term memory along the channels. What is carried forward to the next timestep. The concat is just to keep it tight...
