...
from SpatialTransformer_01 import STN_01

# why can't import????
# give everything better names at some point
class HydraBNUNet07(nn.Module):
    def __init__(self, input_channels, hidden_channels, output_channels, dropout_rate):
        ...
        # spatial transformer
        self.stn = STN_01(input_channels, hidden_channels)
    ...
    def forward(self, x, h):
        ...
        # spatial transformer - id it is to make sense in this recurrent setup, it needs to come after h is concatenated with x
        x = self.stn(x)
