...
class HydraBNUNet01(nn.Module):
    def __init__(self, input_channels, hidden_channels, output_channels, dropout_rate):
        ...
        # HEAD1
        self.dec_conv2_pre1_head1 = nn.Conv2d(base, base, 3, padding=1)
        self.dec_conv2_pre2_head1 = nn.Conv2d(base, base, 3, padding=1)
        ...
        # HEAD2
        self.dec_conv2_pre1_head2 = nn.Conv2d(base, base, 3, padding=1)
        self.dec_conv2_pre2_head2 = nn.Conv2d(base, base, 3, padding=1)
        ...
        # HEAD3
        self.dec_conv2_pre1_head3 = nn.Conv2d(base, base, 3, padding=1)
        self.dec_conv2_pre2_head3 = nn.Conv2d(base, base, 3, padding=1)
    ...
    def forward(self, x, h):
        ...
        #H1
        H1_pre = F.relu(self.bn1_head1(self.dec_conv2_pre1_head1(d1)))
        H1_pre = self.dropout(H1_pre) # is this good?

        H1_pre = F.relu(self.bn2_head1(self.dec_conv2_pre2_head1(H1_pre)))
        H1_pre = self.dropout(H1_pre) # is this good?
        ...
        #H2
        H2_pre = F.relu(self.bn1_head2(self.dec_conv2_pre1_head2(d1)))
        H2_pre = self.dropout(H2_pre)

        H2_pre = F.relu(self.bn2_head2(self.dec_conv2_pre2_head2(H2_pre)))
        H2_pre = self.dropout(H2_pre)
