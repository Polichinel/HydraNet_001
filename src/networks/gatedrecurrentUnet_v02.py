...
class GUNet_v02(nn.Module):
    ...
    def forward(self, x, h):
        ...
        d1_class_ = F.relu(self.dec_conv1_class(torch.cat([self.upsample1_class(d0_class), e0s],1)))  # This here could also be the hidden state - it does work ------------------------------------------------
