...
# ------------------------------------------------------------------
criterion_reg = geomloss.SamplesLoss(loss='sinkhorn', scaling = 0.5, reach = None, backend = 'multiscale', p = 1, blur= 0.01, verbose=False).to(device)
criterion_class = geomloss.SamplesLoss(loss='sinkhorn', scaling = 0.5, reach = None, backend = 'multiscale', p = 1, blur= 0.01, verbose=False).to(device)
