...
def model_pipeline(hyperparameters):
    ...
    with wandb.init(project="RUNET_VIEWS_REP_experiments36", entity="nornir", config=hyperparameters): #monthly36 when you get there--
...
if __name__ == "__main__":
    ...
    # Hyper parameters.
    hyperparameters = {
    "hidden_channels" : 14, # 10 is max if you do full timeline in test.. might nee to be smaller for monthly # you like do not have mem for more than 64
    "input_channels" : 1,
    "output_channels": 1,
